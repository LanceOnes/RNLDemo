        ...
        <>
            <div className="relative">
                <input
                    ...
                    value={value}
                    onChange={onChange}
                    className={`${newInputClassName ? newInputClassName
                ...
                <label
                    htmlFor={name}
                    className={`${newLabelClassName ? newLabelClassName : `absolute text-sm text-body duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-left inset-start-2.5 peer-focus:text-fg-brand peer-placeholder-shown:scale-100 
